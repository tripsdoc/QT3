...
public class TileView extends ZoomPanLayout implements
    ...
    private ScalingMarkerLayout mMarkerLayout;
    ...
    public TileView( Context context, AttributeSet attrs, int defStyleAttr ) {
        ...
        mMarkerLayout = new ScalingMarkerLayout( context );
     ...
     * as markers.
     *
     * @return The ScalingMarkerLayout instance.
     */
    public ScalingMarkerLayout getMarkerLayout() {
     ...
     * @param absoluteAnchorX The x-axis position of a marker will be offset by a number equal to the width of the marker multiplied by this value.
     * @param absoluteAnchorY The y-axis position of a marker will be offset by a number equal to the height of the marker multiplied by this value.
     * @return The View instance added to the TileView.
     */
    public View addLayoutMarker( View view, double x, double y, Float relativeAnchorX, Float relativeAnchorY, float absoluteAnchorX, float absoluteAnchorY ) {
        return mMarkerLayout.addLayoutMarker( view,
    ...
    public void moveToMarker( View view, boolean shouldAnimate ) {
        ...
        if( params instanceof ScalingMarkerLayout.LayoutParams ) {
            ScalingMarkerLayout.LayoutParams anchorLayoutParams = (ScalingMarkerLayout.LayoutParams) params;
     ...
     */
    public void setMarkerTapListener( ScalingMarkerLayout.MarkerTapListener markerTapListener ) {
    ...
    public void onScaleChanged( float scale, float previous ) {
        ...
        mMarkerLayout.setFixedScale(previous);
    }
    ...
    private static class SavedState extends View.BaseSavedState {
        ...
        public static final Parcelable.Creator<TileView.SavedState> CREATOR
                = new Parcelable.Creator<TileView.SavedState>() {
            public TileView.SavedState createFromParcel(Parcel in ) {
                return new TileView.SavedState( in );
            }

            public TileView.SavedState[] newArray(int size ) {
                return new TileView.SavedState[ size ];
            }
        };
    }
    ...
    public Parcelable onSaveInstanceState() {
        ...
        TileView.SavedState ss = new TileView.SavedState( superState );
        ss.mScale = getScale();
    ...
    public void onRestoreInstanceState(Parcelable state) {
        final TileView.SavedState ss = (TileView.SavedState) state;
